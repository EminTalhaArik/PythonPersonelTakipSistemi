...
def personelGoster():
    ...
    imlec.execute("SELECT numara,isim,soyisim,kullaniciAdi FROM kullanicilar")
...
def yetkilendir():
    ...
    imlec.execute("UPDATE kullanicilar set yetki = ? WHERE numara= ?",
...
def girisyap():  #Sisteme Gİriş Alanı
    ...
    imlec.execute("CREATE TABLE IF NOT EXISTS kullanicilar (isim,soyisim,kullaniciAdi,sifre,yetki,numara INTEGER PRIMARY KEY AUTOINCREMENT)")
